...
You've finished the [Quick Start first-time setup](./quick-start.md) — your site has a logo, brand color, fonts, menu, footer, and the 4 essential pages. Now pick what *kind* of site you're building. Each path below tells you what to do next.

> **Haven't done the Quick Start yet?** [Start there](./quick-start.md) — every path below assumes the basics are already in place.
...
|---|---|---|
| [A. Personal or company blog](#a-personal-or-company-blog) | Writers, content creators, journalists, company news pages | 1–2 hours after Quick Start |
| [B. Portfolio](#b-portfolio) | Designers, photographers, freelancers, agencies showcasing work | 2–3 hours |
| [C. Business / brochure site](#c-business-or-brochure-site) | Small businesses, consultancies, service providers, landing pages | 1–2 hours |
| [D. Community / social site](#d-community-or-social-site) | Member networks, alumni groups, fan communities, hobby clubs | 3–4 hours |
...
>
> **Looking for e-commerce, online courses, or a marketplace?** Those features come from separate Wbcom Designs plugins (each free + pro version, sold separately). See the [in-house plugin catalog](https://wbcomdesigns.com/downloads/). BuddyX free + plugins lets you stack only what you need.
...
1. **Pick a blog layout** — go to **Appearance → Customize → Site Blog**. BuddyX ships 4 layouts:
   ...
   Pick what fits your content's image-to-text ratio. Image-heavy posts → Grid or Masonry. Text-heavy long-form → Default or List.
...
[BuddyX Pro](https://wbcomdesigns.com/downloads/buddyx-theme/) adds: 14 color presets, 7 typography presets, per-page sidebar settings (so a single post can override the global sidebar), sign-in popup, and more customizer surface.
...
4. **Use block patterns to build the homepage** — when editing the Home page, click `+` → **Patterns** → **BuddyX**. Drop in a **Hero** pattern, a **Features Grid** pattern, a **Call-to-action** pattern. Replace placeholder text with your value prop + sample work links.
...
[BuddyX Pro](https://wbcomdesigns.com/downloads/buddyx-theme/) adds the **per-page settings** (so the portfolio archive can override the global sidebar setting, the homepage can override the layout, etc.) — useful when portfolio pieces need different presentations than blog posts.
...
2. **Build the homepage with block patterns** — when editing the Home page, drop in:
   ...
   - **Call-to-action** — final "Contact us" or "Get started" prompt
...
[BuddyX Pro](https://wbcomdesigns.com/downloads/buddyx-theme/) adds the **sign-in popup** (visitors sign in via a popup instead of redirecting to `/wp-login.php`) — useful if your business site has a customer login (client portal, member dashboard).
...
And [BuddyX Pro](https://wbcomdesigns.com/downloads/buddyx-theme/) (the theme) adds: sign-in popup (better signup UX than `/wp-login.php` redirect), per-page settings, more BuddyPress customization options, and dark customizer surface.
...
- [Recipes](../recipes/) — focused walkthroughs for specific outcomes (match the demo design, customize brand colors and fonts)
- [Color Scheme](../skin-colors/color-scheme.md) — every color setting explained
