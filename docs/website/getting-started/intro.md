...
See [BuddyX Pro at wbcomdesigns.com](https://wbcomdesigns.com/downloads/buddyx-theme/) when you're ready, or browse the [Wbcom plugin catalog](https://wbcomdesigns.com/downloads/) to see all in-house plugins.
...
- [Personal or company blog](./choose-your-path.md#a-personal-or-company-blog)
- [Portfolio](./choose-your-path.md#a-portfolio)
- [Business / brochure site](./choose-your-path.md#a-business-or-brochure-site)
- [Community / social site](./choose-your-path.md#a-community-or-social-site)
...
- [Quick Start](./quick-start.md) — the mandatory first-time setup walkthrough
- [Installation Guide](./installation.md) — detailed install + activation steps
- [Choose Your Path](./choose-your-path.md) — pick your site type
- [Glossary](../faq-support/glossary.md) — plain-English definitions of WordPress + theme terms

---

**Got questions?** Open an issue on the [BuddyX GitHub repo](https://github.com/vapvarun/buddyx), post on the [WordPress.org support forum](https://wordpress.org/support/theme/buddyx/), or check the [FAQ](../faq-support/faqs.md). Friendly help is one click away.
