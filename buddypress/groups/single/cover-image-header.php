...
<div id="cover-image-container">
	<div id="header-cover-image">
		...
		if ( bp_group_use_cover_image_header() ) {
			if ( bp_is_item_admin() ) {
				?>
				<a href="<?php echo esc_url( $group_cover_link ); ?>" title="<?php echo esc_attr( bp_get_group_name() ); ?>" class="link-change-cover-image bp-tooltip" data-bp-tooltip-pos="right" data-bp-tooltip="<?php esc_attr_e( 'Change Cover Photo', 'buddyx' ); ?>">
	...
	<div id="item-header-cover-image">
		<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
			...
			<?php if ( bp_is_item_admin() ) { ?>
				<a href="<?php echo esc_url( $group_avatar ); ?>" title="<?php echo esc_attr( bp_get_group_name() ); ?>" class="link-change-profile-image bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Change Group Photo', 'buddyx' ); ?>">
					<i class="fa fa-camera"></i>
				</a>
			<?php } ?>
				<?php bp_group_avatar(); ?>
