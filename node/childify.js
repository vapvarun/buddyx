/**
 * BuddyX Childify Script
 *
 * One-time converter to turn BuddyX into a lightweight child theme.
...
async function main() {
	console.log(
		'BuddyX Childify – convert this theme into a lightweight child theme'
	);
