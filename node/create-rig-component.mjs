...
/**
 * BuddyX Component Scaffolding System
 *
 * This script generates a new component for BuddyX with minimal dependencies.
 * Usage: npm run create-component "Component Name" [options]
 *
 * Options:
