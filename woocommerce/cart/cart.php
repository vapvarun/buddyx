	...
	<div class="col-md-8">
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
						<th scope="col" class="product-remove"><span class="screen-reader-text"><?php esc_html_e( 'Remove item', 'buddyx' ); ?></span></th>
						<th scope="col" class="product-thumbnail"><span class="screen-reader-text"><?php esc_html_e( 'Thumbnail image', 'buddyx' ); ?></span></th>
				...
				<tbody>
					...
					foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
						...
						if ( $_product instanceof WC_Product && $_product->exists() && $cart_item['quantity'] > 0 && $visible ) {
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												...
												esc_attr( sprintf( __( 'Remove %s from cart', 'buddyx' ), wp_strip_all_tags( $product_name ) ) ),
												esc_attr( $product_id ),
								...
								<td role="rowheader" class="product-name" data-title="<?php esc_attr_e( 'Product', 'buddyx' ); ?>">
								<?php
								if ( ! $product_permalink ) {
								...
								<td class="product-price" data-title="<?php esc_attr_e( 'Price', 'buddyx' ); ?>">
									<?php
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'buddyx' ); ?>"><?php esc_html_e( 'Update cart', 'buddyx' ); ?></button>
