...
if ( ! function_exists( 'buddyx_skin_cluster_icon' ) ) {
	...
	function buddyx_skin_cluster_icon( $name ) {
		...
		switch ( $name ) {
			...
			case 'flame':
				return $open . '<path d="M8.5 14.5A2.5 2.5.1.0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5.1.0 0 2.5 2.5z"/>' . $close;
			case 'panel-top':
			...
			case 'mouse-pointer-2':
				return $open . '<path d="M4.037 4.688a.495.495.1.0 1 .651-.651l16 6.5a.5.5.1.0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5.1.0 1-.947.063z"/>' . $close;
			case 'panel-bottom':
