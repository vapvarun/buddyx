...
defined( 'ABSPATH' ) || exit;
		...
		\BuddyX\Buddyx\Customizer_Framework\Field::add( 'typography',
			array(
				...
				'section'  => 'headings_typography_section',
				'default'  => array(
					// H6 is intentionally smaller than body but bolder — distinguishes
					// fine-grained block headings without competing with body text.
					'font-family'     => 'newsreader',
					'variant'         => '700',
					'font-style'      => 'normal',
					'font-size'       => '15px',
		...
		\BuddyX\Buddyx\Customizer_Framework\Field::add( 'typography',
			array(
				...
				'default'  => array(
					// Modern editorial baseline: 17px Inter for comfortable reading on
					// retina screens (NYT/Medium/Substack convention). 1.65 leading.
					'font-family'     => 'inter',
					'variant'         => '400',
					'font-style'      => 'normal',
					'font-size'       => '17px',
