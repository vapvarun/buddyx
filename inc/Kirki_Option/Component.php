...
class Component implements Component_Interface
{
    ...
    {
        add_action('customize_register', [$this, 'add_panels_and_sections']);
        add_filter('kirki/fields', [$this, 'add_fields']);
    ...
    public function add_fields($fields)
    {
        ...
        $fields[] = [
            ...
            'active_callback' => [
                ['setting' => 'site_loader', 'operator' => '==', 'value' => '1'],
            ],
        ];
        ...
        $fields[] = [
            ...
            'active_callback' => [
                ['setting' => 'site_sub_header_bg', 'operator' => '==', 'value' => '1'],
            ],
        ];
        ...
        $fields[] = [
            ...
            'active_callback' => [
                ['setting' => 'blog_layout_option', 'operator' => '!==', 'value' => 'default-layout'],
            ],
        ];
        ...
        $fields[] = [
            ...
            'active_callback' => [
                ['setting' => 'site_footer_bg', 'operator' => '==', 'value' => '1'],
            ],
        ];
        ...
        $fields[] = [
            ...
            'default' => esc_attr__('Copyright &copy; 2020. All rights reserved by, <a href="#">WbcomDesigns</a>', 'buddyx'),
            'priority' => 10,
        ];
