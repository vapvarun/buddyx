...
class Component implements Component_Interface {
	...
	public function add_fields( $fields ) {
		...
		$fields[] = array(
			...
			'output'      => array(
				array(
					'element' => 'a.read-more.button, input[type="button"], input[type="reset"], input[type="submit"],
		...
		$fields[] = array(
			...
			'output'      => array(
				array(
					'element' => 'a.read-more.button:hover, input[type="button"]:hover, input[type="reset"]:hover, input[type="submit"]:hover, input[type="button"]:active, input[type="button"]:focus, input[type="reset"]:active, input[type="reset"]:focus, input[type="submit"]:active, input[type="submit"]:focus,
