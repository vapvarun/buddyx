<?php
/**
 * BuddyX\Buddyx\Fonts\Component class
 *
 * @package buddyx
 */
	...
	public function buddyx_register_fonts(): void {
		if ( function_exists( 'wp_register_font_collection' ) ) {
			wp_register_font_collection(
				'modern-stacks',
				array(
					'name'          => __( 'Modern Stacks', 'buddyx' ),
					'description'   => __( 'A collection of modern system fonts.', 'buddyx' ),
					'font_families' => array(
						array(
							'font_family_settings' => array(
								'fontFamily' => 'system-ui, sans-serif',
								'slug'       => 'system-ui',
								'name'       => __( 'System UI', 'buddyx' ),
							),
						...
						array(
							'font_family_settings' => array(
								...
								'name'       => __( 'Monospace Slab Serif', 'buddyx' ),
							),
					...
					'categories'    => array(
						array(
							'name' => __( 'Handwriting', 'buddyx' ),
							'slug' => 'handwriting',
						),
						array(
							'name' => __( 'Monospace', 'buddyx' ),
							'slug' => 'monospace',
						),
						array(
							'name' => __( 'Sans Serif', 'buddyx' ),
							'slug' => 'sans-serif',
						),
						array(
							'name' => __( 'Serif', 'buddyx' ),
							'slug' => 'serif',
						),
					),
				)
