...
// Process time string - only do this when needed
...
// Process author info - only if the post type supports it
...
// Process parent post info - only for attachments with parent
