...
// Check if primary navigation is active once
$primary_nav_active = buddyx()->is_primary_nav_menu_active();
    ...
    <div class="primary-menu-container buddyx-mobile-menu">
        ...
        if ( is_user_logged_in() ) {
            ...
            <div class="buddyx-mobile-user">
                <div class="user-wrap">
                    <a href="<?php echo esc_url( $user_link ); ?>"><?php echo $user_avatar; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></a>
                    <div>
