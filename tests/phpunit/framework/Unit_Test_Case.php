<?php
/**
 * BuddyX Unit_Test_Case class
 *
 * @package buddyx
 */

namespace BuddyX\Buddyx\Tests\Framework;

use PHPUnit\Framework\TestCase;
use Brain\Monkey;
use BuddyX\Buddyx\Template_Tags;
...
class Unit_Test_Case extends TestCase {
	...
	/**
	 * Returns a mock of the BuddyX template tags class for the given methods.
	 *
	 * Furthermore this method will set up `buddyx()` so that when calling the function the mock will be returned.
	 *
	...
	protected function mockTemplateTags( array $methods ) {
		...
		Monkey\Functions\when( 'BuddyX\Buddyx\buddyx' )->justReturn( $component );
