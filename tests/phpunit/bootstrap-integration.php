<?php
/**
 * BuddyX integration tests bootstrap - uses WordPress's built-in PHPUnit compatibility
 *
 * @package buddyx
 */
...
function buddyx_ensure_test_environment() {
	// Get the real system temp directory
	$system_temp = realpath( sys_get_temp_dir() );
	$test_dir    = $system_temp . DIRECTORY_SEPARATOR . 'buddyx-tests' . DIRECTORY_SEPARATOR . 'wordpress-tests-lib';
...
$test_root = buddyx_ensure_test_environment();
