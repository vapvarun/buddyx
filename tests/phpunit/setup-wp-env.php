...
class WP_Test_Setup {
	...
	public function __construct() {
		...
		$this->db_name    = getenv( 'WP_TESTS_DB_NAME' ) ?: 'buddyx_test';
		...
		$this->wp_tests_dir = $real_temp . DIRECTORY_SEPARATOR . 'buddyx-tests' . DIRECTORY_SEPARATOR . 'wordpress-tests-lib';
		$this->wp_core_dir  = $real_temp . DIRECTORY_SEPARATOR . 'buddyx-tests' . DIRECTORY_SEPARATOR . 'WordPress';
		} else {
...
";
	...
	private function download_with_curl( $url, $local_path ) {
		...
		curl_setopt( $ch, CURLOPT_USERAGENT, 'BuddyX Test Setup' );
...
try {
	...
	$test_dir = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'buddyx-tests' . DIRECTORY_SEPARATOR . 'wordpress-tests-lib';
