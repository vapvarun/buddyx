<?php
/**
 * BuddyX\Buddyx\Tests\Unit\Accessibility\Component_Tests class
 *
 * @package buddyx
 */

namespace BuddyX\Buddyx\Tests\Unit\Accessibility;

use phpDocumentor\Reflection\Types\Object_;
use BuddyX\Buddyx\Tests\Framework\Unit_Test_Case;
use Brain\Monkey\Functions;
use Mockery;
use BuddyX\Buddyx\Accessibility\Component;
...
class Component_Tests extends Unit_Test_Case {
	...
	public function test_action_enqueue_navigation_script() {
		...
		Functions\expect( 'wp_enqueue_script' )
			->with( 'buddyx-navigation', Mockery::any(), Mockery::any(), Mockery::any(), Mockery::any() )
			->once();

		Functions\expect( 'wp_script_add_data' )
			->with( 'buddyx-navigation', 'async', true )
			->twice();

		Functions\expect( 'wp_localize_script' )
			->with( 'buddyx-navigation', Mockery::any(), Mockery::any() )
			->once();
