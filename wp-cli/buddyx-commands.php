<?php
/**
 * All Custom WP CLI commands for BuddyX
 *
 * @package buddyx
 */
 ...
 */
class BuddyX_Command extends WP_CLI_Command {
	 ...
	 *      $ buddyx fake_menu_items --menu="Main Menu" --items=8 --subitems=4 --depth=3
	 *
	 ...
	 * ## EXAMPLES
	 *
	 *     buddyx menu export "Main Menu"
	 *     buddyx menu export "Main Menu" --file=main-menu.json
	 *     buddyx menu export "Main Menu" --file=main-menu.json --pretty
	 *
	...
	public function fonts_download( $args, $assoc_args ) {
		...
		$component = new \BuddyX\Buddyx\Fonts\Component();
...
WP_CLI::add_command( 'rig', 'BuddyX_Command' );
