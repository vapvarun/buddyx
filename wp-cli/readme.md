...
**Usage:**
``` bash
buddyx fake_menu_items [options]
```
**Examples:**
...
``` bash
buddyx fake_menu_items --menu="Test Menu" --items=8 --subitems=4 --depth=3
```
Create a menu and assign it to the primary location:
``` bash
buddyx fake_menu_items --items=6 --depth=2 --prefix="Nav Item" --assign-location=primary
```
Create items in an existing menu:
``` bash
buddyx fake_menu_items --menu="Main Navigation" --items=10 --prefix="Page"
```
**Menu Structure:**
...
**Usage:**
``` bash
buddyx menu_export <menu_name> [--file=<filename>] [--pretty]
```

**Examples:**
``` bash
# Export menu to stdout
buddyx menu_export "Main Menu"

# Export menu to a file
buddyx menu_export "Main Menu" --file=main-menu.json

# Export menu to a file with formatted JSON
buddyx menu_export "Main Menu" --file=main-menu.json --pretty
```
...
**Usage:**
``` bash
buddyx menu_import <file> [--overwrite] [--dry-run]
```

**Examples:**
``` bash
# Import menu from file
buddyx menu import main-menu.json

# Import menu and overwrite any existing menu with the same name
buddyx menu import main-menu.json --overwrite

# Test import without making changes
buddyx menu import main-menu.json --dry-run
```
...
**Usage:**
``` bash
buddyx menu_list [--format=<format>]
```
...
``` bash
buddyx fonts_download
buddyx fonts_download --dir=assets/fonts
```
